...
artifacts:
  - name: jhack
    ...
    ssdlc_params:
      ...
      # cycle: '25.04'  # optional; if omitted, will default to the upcoming Ubuntu version
```

> **Note:** The `cycle` field in `ssdlc_params` is optional. If omitted, it will automatically default to the current upcoming Ubuntu version (e.g., `25.10` or `26.04`) based on the current date.
